...
INSERT INTO military VALUES
	('PRK', 950000, 200000, 5889000, 7039000, 278.80),
    ('RUS', 1013628, 2572500, 2310859, 5896987, 41.50),
    ('VNM', 482000, 5000000, 40000, 5522000, 57.40),
    ('USA', 1374699, 845000, 2918161, 5137860, 15.60),
    ('IND', 1440000, 2096000, 1585950, 5121950, 4),
    ('TWN', 275000, 2800000, 	1883450, 4958450, 210.90),
    ('KOR', 599000 , 3100000, 900000, 4599000, 89.90),
    ('IRN', 523000 , 1350000, 2640000, 4513000, 55),
    ('CHN', 2035000, 510000, 1500000, 4045000, 2.90),
    ('CUB', 49000, 1159000, 1465000, 2673000, 239.80);
